...
if _os.environ.get("FRC_DRIVE_NEUTRAL"):
...
DIAG = bool(_os.environ.get("FRC_DRIVE_DIAG"))
HUB = "blue"
...
def main() -> None:
    ...
    try:
        ...
        from frc_rebuilt.robot_model import RobotController
        from frc_rebuilt.shot_planner import FieldState, RobotState, plan_global_score
