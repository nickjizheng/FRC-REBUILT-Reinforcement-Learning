...
def main() -> None:
    ...
    try:
        ...
        from frc_rebuilt.isaac_scene import SceneBuilder
        ...
        controller.preload(fuel, FRC_PRELOAD_COUNT)
        for _ in range(180):
        ...
        from frc_rebuilt.robot_model import quat_wxyz_to_matrix
        compact_ball_local = (
        ...
        # The FRC BigGate collider underside is 0.591 m at this lane.
        ...
        result = {
            ...
            "retained_preloads": len(set(range(FRC_PRELOAD_COUNT)) & set(controller.magazine)),
        ...
        result["passed"] = bool(
            ...
            and result["retained_preloads"] == FRC_PRELOAD_COUNT
        )
