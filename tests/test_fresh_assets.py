...
FIELD = ROOT / "assets" / "fresh_frc" / "field"
ROBOT = ROOT / "assets" / "fresh_frc" / "robot"
...
def test_source_hashes_are_pristine_frc_v20_2b():
...
def test_frc_has_456_physical_fuel_bodies():
    colliders = load(FIELD / "colliders.json")
