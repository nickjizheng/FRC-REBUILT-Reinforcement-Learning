#!/usr/bin/env python3
"""PhysX acceptance for robot field-centric teleop and FRC-style intake."""
...
def main() -> None:
    ...
    try:
        ...
        retained = sum(bool(inside[i]) for i in range(FRC_PRELOAD_COUNT))
        stable_pass = max_robot_z < 0.65 and max_tilt_rad < math.radians(45)
        retention_pass = retained == FRC_PRELOAD_COUNT
